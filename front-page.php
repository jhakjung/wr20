...
$parent_category_id = get_cat_ID('document'); // "document" 카테고리의 ID

echo 'Document 카테고리 ID: ' . $parent_category_id;
$args = [
...
if ($child_categories) {
    foreach ($child_categories as $category) {
        echo '카테고리 이름: ' . esc_html($category->name) . '<br>';
        echo '카테고리 ID: ' . $category->term_id . '<br>';
    }
} else {
    echo '자식 카테고리가 없습니다.';
}
